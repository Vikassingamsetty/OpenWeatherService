#
#  Be sure to run `pod spec lint OpenWeatherService.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "OpenWeatherService/**/*"
  spec.exclude_files = "OpenWeatherService/*.plist"
  spec.public_header_files = "OpenWeatherService/**/*.h"
